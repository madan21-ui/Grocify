...
const userProfile = () => {
  ...
  const displayName = user?.fullName || email?.split("@")[0]; // Fallback to email username if fullName is not available
//split the email to get the username part before the @ symbol
